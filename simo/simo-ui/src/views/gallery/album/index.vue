<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="封面图片ID" prop="coverPhotoId">
        <el-input
          v-model="queryParams.coverPhotoId"
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['gallery:album:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['gallery:album:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="albumList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="相册名称" align="center" prop="title" />
      <el-table-column label="相册描述" align="center" prop="description" />
      <el-table-column label="封面图片ID" align="center" prop="coverPhotoId" />
      <el-table-column label="相册类型 (0:用户自建, 1:AI智能聚类)" align="center" prop="albumType" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="封面图片ID" prop="coverPhotoId">
          <el-input v-model="form.coverPhotoId" placeholder="请输入封面图片ID" />
        </el-form-item>
...
<script>
import { listAlbum, getAlbum, delAlbum, addAlbum, updateAlbum } from "@/api/gallery/album"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除相册管理编号为"' + albumIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('gallery/album/export', {
        ...this.queryParams
